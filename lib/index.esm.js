...
async function upload(signer, address, fileName, fileSize, fileData, dirPath = "", onProgress = noop, onSuccess = noop, onError = noop) {
  if (!signer) {
...
export { createDirectory, index as default, upload };
